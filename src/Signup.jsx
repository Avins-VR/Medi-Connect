    ...
    <div className="min-h-screen w-full flex flex-col items-center justify-start bg-gradient-to-b from-[#91C8E4] to-white relative overflow-hidden px-4">
      ...
      <div className="w-full max-w-[450px] mt-20 md:mt-20 bg-white/30 
        ...
        <p className="text-center text-gray-600 text-sm mt-3 leading-relaxed">
          Join Health Connect and manage your health, <br className="hidden md:block" />
        ...
        <div className="mt-6">
          <div className="flex items-center bg-white/80 rounded-lg px-3 py-3 shadow-sm">
            ...
            <i
              className={`bi ${showConfirmPassword ? "bi-eye" : "bi-eye-slash"} text-gray-500 cursor-pointer`}
  ...
  <div className="flex items-center bg-white/80 rounded-lg px-3 py-3 shadow-sm">
    ...
    >
      ...
      <option value="doctor">Doctor</option>
        ...
        {/* BUTTON */}
        <button className="w-full bg-black text-white py-3 rounded-xl mt-6 font-medium hover:bg-gray-900 transition text-sm md:text-base">
          Create Account
        </button>
        ...
        <p className="text-center mt-6 text-sm text-gray-700">
          Already have an account?{" "}
          <span className="text-blue-700 cursor-pointer hover:underline">Sign in</span>
        </p>
      </div>
    </div>
  );
